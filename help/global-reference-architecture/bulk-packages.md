---
title: Padrão de arquitetura de referência global de pacotes em massa
description: Saiba como configurar o Adobe Commerce usando o padrão GRA de pacotes em massa para gerenciamento de código eficiente, controle de versão e implantações escalonáveis de várias instâncias.
jira: KT-16726
doc-type: Tutorial
duration: 296

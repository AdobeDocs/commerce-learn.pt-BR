...
description: Saiba como usar o Adobe Developer Console para trabalhar com projetos e espaços de trabalho para a API Mesh, incluindo adição de uma malha, logon via CLI e alternância de organizações.
jira: KT-11803
doc-type: Tutorial
duration: 572

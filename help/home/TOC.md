...
+ Adobe Commerce Cloud {#adobe-commerce-cloud}
  ...
  + [Gerenciamento de projetos e ambientes](../cloud/project-environment-management.md)
  + [Como a Adobe Commerce Cloud é dimensionada](../cloud/how-adobe-commerce-cloud-scales.md)
  + [Hospedagem pronta para HIPAA](../cloud/hippa-ready-hosting.md)
  + [Detectar endereço IP](../cloud/detect-ip-address.md)
  ...
  + [Fluxos de marketing](../cloud/marketing-flows.md)
  + [Opções da vitrine eletrônica](../cloud/storefront-options.md)
  + [Compartilhamento de dados](../cloud/data-sharing.md)
  + [Vários sites](../cloud/multiple-websites.md)
...
+ Introdução {#getting-started}
  + Commerce as a Cloud Service {#commerce-as-a-cloud-service}
    ...
    + Visão geral do produto{#product-overview}
      ...
      + [Criação de conteúdo](../commerce-as-a-cloud-service/product-overview/content-authoring.md)
      + [Localizar e agendar conteúdo](../commerce-as-a-cloud-service/product-overview/localize-and-schedule-content.md)
      + [Criação de conteúdo alimentado por GenAI](../commerce-as-a-cloud-service/product-overview/genai-powered-content-creation.md)
      + [Serviços de merchandising e gerenciamento de catálogo](../commerce-as-a-cloud-service/product-overview/catalog-management-and-merchandising-services.md)
      + [Experimentação da vitrine do Commerce](../commerce-as-a-cloud-service/product-overview/commerce-storefront-experimentation.md)
      + [Velocidade da vitrine do Commerce](../commerce-as-a-cloud-service/product-overview/commerce-storefront-speed.md)
      + [Jornada completa do comprador da loja de comércio](../commerce-as-a-cloud-service/product-overview/commerce-storefront-full-shopper-journey.md)
      + [Loja combinável e arquitetura modular](../commerce-as-a-cloud-service/product-overview/composable-storefront-and-modular-architecture.md)
      + [Extensibilidade](../commerce-as-a-cloud-service/product-overview/extensibility.md)
      + [Modernização e migração](../commerce-as-a-cloud-service/product-overview/modernization-and-migration.md)
      + [fechando](../commerce-as-a-cloud-service/product-overview/closing.md)
    + Ferramenta Migração de dados em massa{#bulk-data-migration-tool}
      + [Introdução](../commerce-as-a-cloud-service/bulk-data-migration-tool/introduction.md)
      ...
      + [Migração de várias fases](../commerce-as-a-cloud-service/bulk-data-migration-tool/bulk-data-migration-tool-multi-phase-migration.md)
  + Migração para o Adobe Commerce{#migrating-to-adobe-commerce}
    + [Visão geral](../migrating-to-adobe-commerce/overview.md)
    + Preparação{#preparation}
      + [Avaliar a equipe e o projeto](../migrating-to-adobe-commerce/preparation/evaluate-team-and-project.md)
    + Personalizações{#customizations}
      + [Padrões de código em andamento](../migrating-to-adobe-commerce/customizations/in-process-code-standards.md)
    + QA{#qa}
      + [Congelamento de código](../migrating-to-adobe-commerce/qa/code-freeze.md)

  + Recursos do Commerce {#capabilities}
    + [Opções de comércio disponíveis](../capabilities/adobes-available-commerce-options.md)
  ...
  + Kit inicial de integração back office {#back-office-integration-starter-kit}
    ...
    + [Organização do código Source](../back-office-integrations/source-code-organization.md)
...
+ Extensibilidade {#extensibility}
  + Agente de desenvolvedor do Commerce {#commerce-developer-agent}
    + [Visão geral](../commerce-developer-agent/adobe-commerce-developer-agent-overview-technical-video.md)
    + [Blueprint e estágios de desenvolvimento](../commerce-developer-agent/adobe-commerce-developer-agent-blueprint-and-develop-stages-technical-video.md)
    + [Conectar integrações](../commerce-developer-agent/adobe-commerce-developer-agent-connect-integrations-technical-video.md)
    + [Implantar, associar, instalar](../commerce-developer-agent/adobe-commerce-developer-agent-deploy-associate-and-install-technical-video.md)
    + [Configurar e testar](../commerce-developer-agent/adobe-commerce-developer-agent-configure-and-test-technical-video.md)
    + [Migrar código existente](../commerce-developer-agent/adobe-commerce-developer-agent-migrate-existing-code-technical-video.md)
    + [Conclusão](../commerce-developer-agent/adobe-commerce-developer-agent-conclusion-technical-video.md)
    + [simulação do App Builder](../commerce-developer-agent/adobe-commerce-developer-agent-app-builder-dry-run.md)
  + Desenvolvimento de back-end {#backend-development}
    ...
    + [Conectar e executar consultas no banco de dados do Adobe Commerce](../backend-development/remote-db-connection-execute-queries.md)
    + Atualizações do Commerce {#upgrade}
      ...
      + [Usar a ferramenta de compatibilidade de atualização no PhpStorm](../upgrade/uct-phpstorm.md)
  + Desenvolvimento de front-end do Luma {#frontend-development}
    + Page Builder PaaS/SaaS para desenvolvedores {#page-builder}
    ...
    + Edge Delivery Services {#edge-delivery-services}
      + Introdução {#getting-started}
        ...
        + [Experiência do comprador](../edge-delivery-services/shopper-experience.md)
    + Arquitetura headless {#headless-architecture}
      ...
      + Introdução ao PWA Studio {#introduction}
        + [Visão geral](../pwa/introduction/1-overview.md)
        + [Ferramentas do PWA Studio](../pwa/introduction/2-pwa-studio-tools.md)
        + [Launch](../pwa/introduction/3-launch.md)
        + [PARA CIMA](../pwa/introduction/4-upward.md)
        + [Introdução](../pwa/introduction/5-getting-started.md)
  ...
  + Adobe Developer App Builder {#adobe-developer-app-builder}
    ...
    + Use as ferramentas de IA para criar POC de pagamento dividido {#create-a-split-payment-poc}
      ...
      + Recursos de referência {#split-payment-resources}
    ...
    + Criar taxas de envio personalizadas usando as Ferramentas de IA {#custom-shipping-rates-ai-tools}
      ...
      + [Fornecer feedback à Adobe](../app-builder/custom-shipping-rates-ai-tools/feedback.md)
...
+ Administração de armazenamento {#admin}
  ...
  + [Redefinir o URI do administrador](../site-management/reset-admin-uri.md)
...
+ Ferramentas e serviços externos {#tools}
  ...
  + [Serviço de patch de automação na nuvem](../tools/cloud-automation-patching-service.md)
  ...
  + New Relic {#new-relic}
    ...
    + [Alertas personalizados](../new-relic/custom-alerts.md)

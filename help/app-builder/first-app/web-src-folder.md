...
* Desenvolvedores novos no Adobe Commerce com experiência limitada usando o Adobe App Builder que estão aprendendo sobre o `web-src` e seu conteúdo.
...
No exemplo abaixo, a amostra de código é `not` limitação da solicitação. Para evitar um erro 400, reduza o tamanho da resposta usando `searchCriteria`.

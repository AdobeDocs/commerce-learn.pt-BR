---
title: POC de pagamento dividido — App Builder e ferramentas de IA
...
Este é o primeiro de um conjunto de tutoriais que apresenta o uso do desenvolvimento assistido por IA para ajudar você a criar uma prova de conceito de pagamento dividido. Você trabalha com o Adobe App Builder e o Adobe Commerce na nuvem (PaaS) ou no local, passando de uma visão geral nesta sessão para os tutoriais práticos que se seguem. Espere metas, arquitetura de alto nível e um roteiro para o que o restante da série aborda.
...
#### A lição de arquitetura (ensino fundamental)

O tutorial demonstra uma estrutura de decisão deliberada e repetível:

* **O que deve ficar no PHP:** qualquer item que seja executado de forma síncrona no ciclo de solicitações do Commerce ou que chame APIs internas da Commerce sem superfície externa limpa
* **O que é movido para o App Builder:** todo o resto — processamento de eventos, fluxo de trabalho do operador, integrações externas e ferramentas voltadas para o operador

---
title: Opções de comércio disponíveis para o Adobe
...
* VP/Diretor da Commerce
* Liderança técnica
* Engenheiros de DevOps/Platform
* Gerente de tecnologia de marketing

## Conteúdo de vídeo

* Comparar modelos de implantação do Adobe Commerce: no local, em nuvem, SaaS e Otimizer
* Saiba quem gerencia a infraestrutura e os aplicativos em cada opção

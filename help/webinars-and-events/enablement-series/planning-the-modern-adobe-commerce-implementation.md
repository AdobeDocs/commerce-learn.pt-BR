...
Este webinário fornece uma visão geral abrangente de vários tópicos relacionados ao Adobe Commerce, incluindo serviço de catálogo, compreensão da arquitetura do cliente e Edge Delivery Services.
&#x200B;Os tópicos incluem recursos e benefícios novos ou existentes de cada serviço, como pesquisa em tempo real e recomendações de produtos no Catálogo do Adobe Commerce como um serviço, análise de APIs e fluxo de dados para entender a arquitetura do cliente, além do alto desempenho e da baixa latência do Edge Delivery Services. Além disso, o documento menciona a importância de ter documentos padrão e uma lista de perguntas ao interagir com os clientes, bem como o conceito de arquitetura de referência global (GRA) para a criação eficiente de projetos.
...
* O serviço de catálogo, incluindo a pesquisa em tempo real e recomendações de produto, está incluído no Adobe Commerce e tem guias disponíveis no Experience League.
...
* O Edge Delivery Services, lançado recentemente para o Adobe Commerce, oferece soluções de vitrine de alto desempenho com baixa latência e experiências de criação simplificadas.
* O Edge Delivery Services prioriza o desempenho e pode melhorar significativamente as pontuações máximas, o SEO e a velocidade geral do site.

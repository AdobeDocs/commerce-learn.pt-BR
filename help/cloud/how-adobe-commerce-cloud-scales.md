---
title: Como a Adobe Commerce Cloud é dimensionada
...
# Como a Adobe Commerce Cloud é dimensionada

Este tutorial explica como a capacidade funciona na Adobe Commerce Cloud, o que é dimensionado automaticamente, quando envolver o Adobe ou suporte e como planejar picos planejados em relação ao tráfego viral inesperado. Use a transcrição como o script de narração ao gravar o vídeo do Experience League.

## Para quem é este vídeo?

* Arquiteto de soluções
* Engenheiro de operações em nuvem
* Gerente técnico do programa
